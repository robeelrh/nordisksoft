...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative min-h-[60vh] w-full flex items-start justify-center overflow-hidden">
      <Image
  ...
  {t("title")}
        ...
        <div className="flex flex-col md:flex-row justify-between w-full gap-6 md:gap-4">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
            <p className="w-full md:w-4/5 lg:w-2/3 text-sm sm:text-base">{t("description")}</p>
          </motion.div>
