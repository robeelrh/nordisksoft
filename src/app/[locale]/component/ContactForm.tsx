  ...
  return (
    <div className="w-full">
      <form
        ...
        className="flex flex-col space-y-4 w-full z-10 text-white/40"
      >
        <div>
          <input
            type="text"
            placeholder="Name*"
            className="bg-[#F4F4F5] border border-white/40 focus:border-black/10 rounded-lg w-full p-4 text-base md:text-md focus:outline-none  placeholder-black/40 text-black transition-colors duration-200"
            {...register("name")}
            ref={(e) => {
              register("name").ref(e);
              nameRef.current = e;
        ...
        {/* <div className="relative" ref={dropdownRef}>
          <div
            ref={serviceRef}
            className="bg-[#F4F4F5] border-b border-white/40 w-full py-2 sm:py-3 text-base sm:text-base focus:outline-none focus:border-white/60 cursor-pointer transition-colors duration-200 flex justify-between items-center"
          ...
          >
            <span
              className={selectedService ? "text-white/80" : "text-white/40"}
            >
            ...
            <div className="absolute top-full left-0 right-0 bg-black/90 border border-white/20 rounded-md mt-1 z-50">
              {serviceOptions.map((option) => (
                <div
                  ...
                  onClick={() =>
                    handleServiceSelect(option.value, option.label)
                  }
                >
                  {option.label}
                </div>
        ...
        <div>
          <textarea
            ...
            className="bg-[#F4F4F5] border-b border-white/40 w-full py-2 sm:py-3 text-base sm:text-base focus:outline-none focus:border-white/60 placeholder-white/40 resize-none transition-colors duration-200"
            {...register("message")}
            ref={(e) => {
