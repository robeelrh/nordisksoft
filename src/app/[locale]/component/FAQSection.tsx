...
export default function FAQSection() {
  ...
  return (
    <section className="min-h-[60vh] w-11/12 xl:w-4/5 mx-auto flex flex-col lg:flex-row items-start px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 font-inter overflow-hidden">
